  ...
  Future<void> fetchData() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        List<UserList> usersList = dataList.map((json) => UserList.fromJson(json)).toList();


        pro.usersList = usersList;
        // box.put(2,dataList);
        // List<UserList> storedData = box.get(2);
  ...
  Future<void> userData() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        data = User.fromJson(user[0]);
        box.put(0, user[0]);

        // var storedData = box.get(1);
        // print("Hive data: ${storedData["lastName"]}");
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      // print(filteredContacts[index].clerkPhone[index]);


                                      child:
                                      // print(
                                      //     filteredContacts[index].clerkName[1]);
                                       showDialog(
                                        context: context,
                                        builder: (context) => InfoDialog(
                                          ...
                                          clerks: [
                                            ClerkInfo(
                                                name:
                                                    filteredContacts[index].clerkName1??"",
                                                phone:
                                                    filteredContacts[index].clerkPhone1??""),
